...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            createCache(cm, com.zolotyh.xris.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, com.zolotyh.xris.repository.UserRepository.USERS_BY_EMAIL_CACHE)
            createCache(cm, com.zolotyh.xris.domain.User::class.java.name)
            createCache(cm, com.zolotyh.xris.domain.Authority::class.java.name)
