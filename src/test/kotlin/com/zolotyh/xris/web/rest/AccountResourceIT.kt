...
import com.zolotyh.xris.config.DEFAULT_LANGUAGE
import com.zolotyh.xris.domain.PersistentToken
import com.zolotyh.xris.domain.User
import com.zolotyh.xris.repository.AuthorityRepository
...
import com.zolotyh.xris.security.USER
import com.zolotyh.xris.service.UserService
import com.zolotyh.xris.service.dto.PasswordChangeDTO
import com.zolotyh.xris.service.dto.UserDTO
import com.zolotyh.xris.web.rest.vm.KeyAndPasswordVM
import com.zolotyh.xris.web.rest.vm.ManagedUserVM
...
@Throws(Exception::class) fun testGetCurrentSessions() {
        val user = User(
            password = RandomStringUtils.random(60),
        ...
        restAccountMockMvc.perform(get("/api/account/sessions"))
            ...
            .andExpect(jsonPath("\$.[*].tokenDate").value(hasItem(token.tokenDate.toString())))
    }

    @Test
    @Transactional
    @WithMockUser("invalidate-session")
@Throws(Exception::class) fun testInvalidateSession() {
        val user = User(
            password = RandomStringUtils.random(60),
