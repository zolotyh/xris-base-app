...
import { TransactionXrisComponent } from 'app/entities/transaction-xris/transaction-xris.component';
...
describe('Component Tests', () => {
  describe('TransactionXris Management Component', () => {
    let comp: TransactionXrisComponent;
    let fixture: ComponentFixture<TransactionXrisComponent>;
    let service: TransactionXrisService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [XrisTestModule],
        declarations: [TransactionXrisComponent],
        providers: [
          {
        ...
        .overrideTemplate(TransactionXrisComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(TransactionXrisComponent);
