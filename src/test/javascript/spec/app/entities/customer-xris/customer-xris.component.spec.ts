...
import { CustomerXrisComponent } from 'app/entities/customer-xris/customer-xris.component';
...
describe('Component Tests', () => {
  describe('CustomerXris Management Component', () => {
    let comp: CustomerXrisComponent;
    let fixture: ComponentFixture<CustomerXrisComponent>;
    let service: CustomerXrisService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [XrisTestModule],
        declarations: [CustomerXrisComponent],
        providers: [
          {
        ...
        .overrideTemplate(CustomerXrisComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(CustomerXrisComponent);
