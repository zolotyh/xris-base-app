...
import { ClientXrisComponent } from 'app/entities/client-xris/client-xris.component';
...
describe('Component Tests', () => {
  describe('ClientXris Management Component', () => {
    let comp: ClientXrisComponent;
    let fixture: ComponentFixture<ClientXrisComponent>;
    let service: ClientXrisService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [XrisTestModule],
        declarations: [ClientXrisComponent],
        providers: [
          {
        ...
        .overrideTemplate(ClientXrisComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(ClientXrisComponent);
